...
describe("Shapes.Shapes", () => {
    ...
    describe("Shapes.Triangle", () => {
        it("Should exemplify a triangle SVG", () =>{
            ...
            expect (generatedShape).toBe(`<svg version ="1.1" width = "350" height = "350" xmlns = "http://www.w3.org/2000/svg"><polygon points= "150, 18 224, 182 56, 182" fill ="${shapeColor}"/><text x ="150" y="125" font-size = "50" text-anchor="middle" fill = "${textColor}">${text}</text></svg>`)
        })
    })
