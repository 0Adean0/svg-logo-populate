...
describe("Shapes.Shapes", () => {
    ...
    describe("Shapes.Rectangle", () => {
        it("Should exemplify a rectangle SVG", () =>{
            ...
            expect (generatedShape).toBe(`<svg version ="1.1" width = "350" height = "350" xmlns = "http://www.w3.org/2000/svg"><rect x= "10" y="10" width="120" height ="120" fill="${shapeColor}"/><text x ="60" y="65" font-size="50" text-anchor="middle" dominant-baseline="middle" fill ="${textColor}">${text}</text></svg>`)
        })
    })
